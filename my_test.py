    ...
    'AddToPlaylist': {
        ...
        'slot_info': {
            ...
            'playlist_owner': {
                ...
                'my_template': 'the playlist is %s playlist.',
                'question': 'whose playlist?',
                'before': 'the playlist is ',
                'after': ' playlist.'
...
query = 'what is the name of the song? sentence: i am going to add love letter to my list of parties. answer: the song is what is the name of the song?. sentence: add song to daily lift playlist. answer: the song is <mask>.'
tr = 'the song is love letter.'
pred = 'the song is the most popular song.'

print(parse_each_slot(tr, domain, slot, query))
print(parse_each_slot(pred, domain, slot, query))